...
from .pipeline_wan_fun_inp_cfg import WanFunInpaintPipeline2
...
WanI2VPipeline2 = WanFunInpaintPipeline2
...
if importlib.util.find_spec("paifuser") is not None:
    ...
    WanFunInpaintPipeline2.__call__ = sparse_reset(WanFunInpaintPipeline2.__call__)
